...
const HomeComponent = () => {
    ...
    const sortedProducts = useMemo(() => sortProducts(data, sortType), [sortType] )
    ...
    return (
        <Container>
            ...
            <div className="text-center mt-[50px]">
                <h2 className="font-['Lato'] text-zinc-800 text-7xl font-black leading-[93.60px] tracking-wide">All Products</h2>
                <select className="border border-cyan-800 p-2 rounded-xl font-['Lato'] text-zinc-800 font-bold shadow-xl bg-zinc-300 outline-none" defaultValue={sortType} onChange={(e) => setSortType(e.target.value)}>
